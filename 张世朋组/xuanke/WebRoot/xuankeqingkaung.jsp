...
<body>
	...
	<div class="b2">
		<ul class="nav nav-pills nav-stacked b1">
			...
			<li class="active"><a href="#">查看选课情况</a></li>
	...
	<table class="table table-hover c1">
		...
		<c:forEach items="${requestScope.chakankecheng}" var="user">
	...
	<p >
       <a href="fenye?page=${paging.indexpage-1}">&lt;&lt; 首页 </a>
       <a href="fenye?page=${paging.page-1 }">    &lt; 上一页 </a>
       <strong>第${paging.page+1}页/共${paging.pagenumber}页</strong>
       <a href="fenye?page=${paging.page+1}">下一页 &gt;</a>
       <a href="fenye?page=${paging.pagenumber-1}">末页 &gt;&gt;</a>
   </p>
