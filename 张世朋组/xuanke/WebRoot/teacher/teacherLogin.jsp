...
<body class="imag1">
	<div>
		<img class="imag1" src="../image/t01b52ad80d1db4379e.jpg" alt="" />
	</div>
	<form action="../servlet/teacherlog" name="login" method="post">
		<div class="l2">
			<table class="table1">
				<tr class="t">
					<td colspan="2" align="center" class="b1">教师登录</td>
				</tr>
				<tr class="t1">
