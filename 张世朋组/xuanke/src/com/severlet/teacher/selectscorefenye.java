...
public class selectscorefenye extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			list = teacherdao.selectscore(name);
		...
		if (list.size() != 0) {
			...
			request.setAttribute("scorelink", list);
			request.getRequestDispatcher("teacher/selectscore.jsp").forward(
					request, response);
		}
	}
