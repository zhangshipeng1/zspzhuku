...
public class chengjifenye extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String name=
				(String) this.getServletContext().getAttribute("name");//获取全局变量里得值
		List<teacher> list=new ArrayList<>();
		
		
		try {
			list = teacherdao.selectcourse(name); 
		...
		request.getRequestDispatcher("teacher/selectcourse.jsp").forward(request, response);
	}
	}
